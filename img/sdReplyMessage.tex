...
\draw[angle 60-, dashed, thick] (0,8) -- node[above, draw=none,yshift=-0.9cm]{methodName()} (3,8);
\draw[angle 60-, dashed, thick] (0,8) -- node[below, draw=none,yshift=+0.7cm]{$prob \in [0,1]$} (3,8);
\end{tikzpicture}
